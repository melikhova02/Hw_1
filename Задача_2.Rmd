...
В данной задаче установим стандартное отклонение случайного шума равное 2 и рассмотрим изменения, которые произойдут в связи с данным условием. 
...
С изменением разброса случайной составляющей значения MSE обучающей и тестовой выборок увеличились в несколько раз. Увеличение разброса наблюдаемых значений уменьшает надежность оценок. Однако построение окончательного графика в пункте 5 показывает, что построенная модель оказалась близка к исходным данным. 
